...
<body>
    <header>
        <div class="navbar">
            <div class="logo"><a href="#">Hotel Wilmor</a></div>
            <ul class="links">
    ...
    <main>
        ...
        <!--QUIENES SOMOS-->
        <section class="container quienes-somos-container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <center>
                        <br><br><br><br>
                        <p>Somos un hotel fundado en 2014, ubicado en el Estado Táchira, Venezuela. Nuestra misión
                            es ofrecer a nuestros huéspedes una experiencia única y memorable, con habitaciones cómodas,
                            servicios de alta calidad y un trato personalizado.
                        </p>
                        <p>Contamos con un equipo de profesionales experimentados y apasionados por brindar la mejor atención
                            a nuestros huéspedes. Desde nuestra recepción hasta nuestro personal de limpieza y
                            mantenimiento, todos trabajamos juntos para crear un ambiente acogedor y confortable.</p>
                    </center>
                </div>
                <div class="col-md-6">
                    <img src="SVG/logo.svg" alt="Logo Hotel" class="img-fluid">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <img src="images/gerentehotel.jpg" alt="Gerente" class="img-fluid rounded-circle mb-2">
                    <center>
                        <h4>Ali Hernandez</h4>
                        <p>Gerente General</p>
                    </center>
                ...
                <div class="col-md-4">
                    <img src="images/encargado.jpg" alt="Encargado" class="img-fluid rounded-circle mb-2">
                    <center>
                        <h4>Carmen Figueroa</h4>
                        <p>Jefe de Recepción</p>
                    </center>
                </div>
                <div class="col-md-4">
                    <img src="images/mantenimiento.jpg" alt="Mantenimiento" class="img-fluid rounded-circle mb-2">
                    <center>
                        <h4>Jose Toussaint</h4>
        ...
        <br><br><br>
        <!-- SERVICIOS-->
        <section class="container my-5  fondo">
            <h2 class="text-center mb-4 titulo">Nuestros servicios</h2>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/Recepcion.jpg" alt="Hotel" class="card-img-top">
                        <div class="card-body">
                            <center>
                                <h4 class="card-title">Hotel</h4>
                                <p class="card-text">Hoteleria y Turismo</p>
                            </center>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/bar.jpg" alt="Bar" class="card-img-top">
                        <div class="card-body">
                            <center>
                                <h4 class="card-title">Bar</h4>
                                <p class="card-text">Sitio acojedor con una iluminación suave</p>
                            </center>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/restaurant.jpg" alt="Restaurant" class="card-img-top">
                        <div class="card-body">
                            <center>
                                <h4 class="card-title">Restaurant</h4>
                                <p class="card-text">Especializados en comidas chinas e italianas</p>
                            </center>
                        </div>
                    </div>
                </div>
        ...
        <!--FORMULARIO-->
        <section class="container my-5 fondo">
            <h2 class="text-center mb-4 titulo">Contáctanos</h2>
            <form action="aplicativo/procesar_formulario.php" method="POST" netlify>
                <div class="form-row">
